...
local Consider ={}
local CanCast={AbilityExtensions.PhysicalCanCast_NoSelf,utility.NCanCast,utility.NCanCast,utility.UCanCast,utility.UCanCast}
...
Consider[3]=function()
	...
	local allys = npcBot:GetNearbyHeroes( Radius+300, false, BOT_MODE_NONE );
