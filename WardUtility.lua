...
local RADIANT_MANDATE1 = Vector(-2948.000000, 769.000000, 0.000000);
local RADIANT_MANDATE2 = Vector(1795.000000, -2809.000000, 0.000000);

local RADIANT_AGGRESSIVETOP  = Vector(-1767.000000, 4812.000000, 0.000000);
...
local DIRE_MANDATE2 = Vector(-1281.000000, 2821.000000, 0.000000);
