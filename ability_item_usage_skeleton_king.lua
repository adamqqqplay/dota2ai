...
Consider[3]=function() --Location AOE Example
	...
	if ( npcBot:GetActiveMode() == BOT_MODE_FARM
		and npcBot:GetModifierStackCount("modifier_skeleton_king_mortal_strike") > 2 and ManaPercentage > 0.45) 
	then
	...
	then
		...
		if ( npcEnemy ~= nil 
		and npcBot:GetModifierStackCount("modifier_skeleton_king_mortal_strike") > 2) 
		then
			return BOT_ACTION_DESIRE_HIGH
		end
	end
