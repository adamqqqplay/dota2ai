...
cast.Type = {}
local Consider = {}
local CanCast = { utility.NCanCast, utility.NCanCast, utility.NCanCast, utility.NCanCast, utility.NCanCast,
	utility.NCanCast }
...
Consider[4] = function()
	...
	local tableNearbyEnemyHeroes = AbilityExtensions:GetNearbyNonIllusionHeroes(npcBot, nCastRange - 200, true,
		BOT_MODE_NONE);
