...
end,utility.NCanCast,utility.UCanCast,utility.NCanCast}
		...
		then
			...
			then
				...
				-- HeroHealth<=WeakestEnemy:GetActualIncomingDamage(Damage,DAMAGE_TYPE_MAGICAL) or
				 (HeroHealth<=WeakestEnemy:GetActualIncomingDamage(GetComboDamage(),DAMAGE_TYPE_MAGICAL) and npcBot:GetMana()>ComboMana)
				then
...
-- copied from abyssal_underlord_firestorm
Consider[4]=function() --Location AOE Example
