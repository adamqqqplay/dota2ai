...
local function GetComboDamage()
	...
	then
		...
		--ctime=ctime+AbilitiesReal[2]:GetSpecialValueFloat("duration")
	end]]--
	if AbilitiesReal[3]:IsFullyCastable()
	then
		sum=sum+AbilitiesReal[3]:GetAbilityDamage() --GetSpecialValueFloat("total_damage")
		--ctime=ctime+AbilitiesReal[3]:GetSpecialValueFloat("channel_time")
	end
